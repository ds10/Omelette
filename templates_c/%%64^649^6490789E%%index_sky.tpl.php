<?php /* Smarty version 2.6.21-dev, created on 2013-04-15 09:13:35
         compiled from index_sky.tpl */ ?>

<body>
   <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "d3-graph.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
   <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "d3-bubbles.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>	
    ...
    <div id="mainPicture">
    	<div class="picture">
            ...
            <div id="headerSubtext">What does the world currently look like?</div>
        </div>
    </div>
    	...
    	<div class="innerBox">
        	...
        	<div class="contentTitle">d3.js example 1</div>
        	<iframe src="lib/backend_graph.php"  width="640" height="345" frameBorder="0" scrolling="no"></iframe>
        	
       
        
        <div class="contentTitle">d3.js example 2</div>
                	<iframe src="lib/backend_circle.php"  width="640" height="345" frameBorder="0" scrolling="no"></iframe>
            <div class="contentText"></div>
        
        
        <div class="contentTitle">d3.js example 3</div>
